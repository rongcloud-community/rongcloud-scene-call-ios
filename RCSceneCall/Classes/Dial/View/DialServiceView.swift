...
final class DialServiceView: UIView {
    ...
    private lazy var avatarImageView: UIImageView = {
        ...
        instance.image = RCSCAsset.Images.customerServiceAvatar.image
    ...
    private lazy var bgImageView: UIImageView = {
        ...
        instance.image = RCSCAsset.Images.dialCustomerBg.image
        instance.clipsToBounds = true
        return instance
    }()
    private lazy var contactImageView: UIImageView = {
        let instance = UIImageView()
        instance.contentMode = .scaleAspectFit
        instance.image = RCSCAsset.Images.customServiceContact.image
        return instance
    }()
