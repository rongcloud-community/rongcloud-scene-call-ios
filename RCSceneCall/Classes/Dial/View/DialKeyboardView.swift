...
class DialKeyboardView: UIView, View {
    ...
    fileprivate lazy var hideButton: UIButton = {
        ...
        instance.setImage(RCSCAsset.Images.dialHideIcon.image, for: .normal)
        instance.transform = CGAffineTransform(scaleX: 0.5, y: 0.5)
        return instance
    }()
    fileprivate lazy var dialButton: UIButton = {
        let instance = UIButton()
        instance.setImage(RCSCAsset.Images.dialCallingIcon.image, for: .normal)
        return instance
    }()
    private lazy var deleteButton: UIButton = {
        let instance = UIButton()
        instance.setImage(RCSCAsset.Images.dialDeleteIcon.image, for: .normal)
        instance.transform = CGAffineTransform(scaleX: 0.5, y: 0.5)
        return instance
    }()
